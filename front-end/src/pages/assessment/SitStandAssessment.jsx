  ...
  return (
    <div className="h-full flex flex-col gap-2">
      ...
      <div className="zeiss-card overflow-hidden flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 min-h-[50px] px-1"><EChart option={seatLineOpt} height="100%" /></div>
      ...
      <div className="zeiss-card overflow-hidden flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 min-h-[50px] px-1"><EChart option={footLineOpt} height="100%" /></div>
        <div className="px-3 py-1 space-y-0 shrink-0">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center zeiss-overlay animate-fadeIn">
          <div className="zeiss-dialog p-8 w-[420px] max-w-[90vw] animate-scaleIn text-center">
            ...
            <p className="text-base leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
              开始评估后，以最快速度完成<span className="font-bold" style={{ color: '#059669' }}>3个周期的坐起动作</span>，<span className="font-bold" style={{ color: '#059669' }}>坐姿开始，坐姿结束</span>。
            </p>
            <button
